        ...
        <th>Action</th>
                ...
                <tbody>
                    @foreach ($notices as $notice)
                        <tr onclick="window.location='{{ route('teacher.noticeview', $notice->id) }}'" style="cursor:pointer;">
                            <td>{{ $notice->title }}</td>
                            <td>{{ $notice->shortdescription }}</td>
                            <td>{{ $notice->created_at->format('d M Y') }}</td>
                            <td>
                                <a href="{{ route('teacher.noticeview', $notice->id) }}" class="btn btn-sm btn-primary">
